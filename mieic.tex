...
%%----------------------------------------
\title{T\'itulo do Relat\'orio de Projecto/Disserta\c{c}\~ao}
\author{Nome do Autor}
\degree{Relat\'orio de Projecto/Disserta\c{c}\~ao\\[2mm]
Mestrado Integrado em Engenharia Inform\'atica e Computa\c{c}\~ao}
%% Date of submission
\thesisdate{7 de Julho de 2008}
...
\signature
\committeemember{Vogal}{Nome do Arguente}{(T\'itulo)}
\committeemember{Vogal}{Nome do Orientador}{(T\'itulo)}
\committeedate{31 de Julho de 2008}
